...
import { RoomLinkListItem } from "./RoomLinkListItem";

interface RoomLinkListViewProps {
  links: RoomLinkListDto[];
  editingLinkId: number | null;
  editingLinkTitle: string;
  submittingId: number | null;
  onEditLink: (link: RoomLinkListDto) => void;
...
export const RoomLinkListView: React.FC<RoomLinkListViewProps> = ({
  links,
  editingLinkId,
  editingLinkTitle,
  submittingId,
              ...
              >
                {sectionLinks.map((link) => (
                  <RoomLinkListItem
                    ...
                    editingTitle={editingLinkTitle}
                    submitting={submittingId === link.id}
                    onEdit={onEditLink}
